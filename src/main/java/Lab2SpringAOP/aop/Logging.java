...
public class Logging {
    ...
    @Pointcut("@annotation(Lab2SpringAOP.aop.annotation.MET)")
    ...
    @Pointcut("execution(* Lab2SpringAOP.*.*.*(..))")
    public void executionDeprecated() {}

    @Pointcut("execution(* Lab2SpringAOP.services.*.*(..))")
